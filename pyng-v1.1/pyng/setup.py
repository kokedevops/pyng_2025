...
from pyng import db, config, app
from pyng.database import Users, Polling, SmtpServer, WebThemes
from pyng.forms import FirstTimeSetupForm
from pyng.main import init_schedulers, database_configured
from pyng.autenticacion import test_password
...
def setup():
    ...
    if request.method == 'GET':
        ...
        # Create admin user
        admin_user = Users(email=form.email.data, username=form.username.data,
        ...
        # Setup STMP server
        smtp = SmtpServer(smtp_server=form.smtp_server.data, smtp_port=form.smtp_port.data,
